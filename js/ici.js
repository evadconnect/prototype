...
const ICI_CATALOG = [
  ...
  { id: 'eco_eau',   nom: 'Eau potable économisée',   livre: 'ecologie', unite: 'L/an',       point0: 0,  point100: 40000, poids: 1,
    ...
    photo: 'https://images.unsplash.com/photo-1519692933481-e162a57d6721?w=800&q=80&auto=format&fit=crop',
  ...
  { id: 'eco_fraicheur', nom: 'Rafraîchissement obtenu', livre: 'ecologie', unite: '°C en été', point0: 0, point100: 4, poids: 1,
    ...
    photo: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&q=80&auto=format&fit=crop',
  ...
  { id: 'eco_dechets', nom: 'Déchets détournés de l\'enfouissement', livre: 'ecologie', unite: 'kg/an', point0: 0, point100: 2000, poids: 1,
    ...
    solutionIds: ['Compostage partagé', 'Repair café', 'Réemploi matériaux', 'Toilettes sèches', 'Conserverie anti-gaspi', 'Réemploi informatique'] },
  { id: 'eco_prod_locale', nom: 'Production locale', livre: 'ecologie', unite: 'kg/an', point0: 0, point100: 3000, poids: 1,
    ...
    solutionIds: ['Jardin permaculture', 'Potager en buttes', 'Haie champêtre', 'AMAP circuit court', 'Conserverie anti-gaspi'] },
  // ── Social ──
  { id: 'soc_insertion', nom: 'Personnes en insertion accueillies', livre: 'social', unite: 'personnes/an', point0: 0, point100: 12,  poids: 1,
    ...
    photo: 'https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?w=800&q=80&auto=format&fit=crop',
  ...
  { id: 'soc_formation', nom: 'Heures de formation dispensées',     livre: 'social', unite: 'heures/an',    point0: 0, point100: 400, poids: 1,
    ...
    solutionIds: ['Jardin permaculture', 'Repair café', 'Compostage partagé', 'Atelier de transmission', 'Réemploi informatique'] },
  { id: 'soc_benevoles', nom: 'Bénévoles mobilisés', livre: 'social', unite: 'personnes/an', point0: 0, point100: 40, poids: 1,
    ...
    solutionIds: ['Isolation paille', 'Potager en buttes', 'Haie champêtre', 'Mare écologique', 'Désimperméabilisation des sols', 'Chantier participatif', 'Café associatif', 'Épicerie participative'] },
  { id: 'soc_sensibilisation', nom: 'Personnes sensibilisées', livre: 'social', unite: 'personnes/an', point0: 0, point100: 300, poids: 1,
    ...
    photo: 'https://images.unsplash.com/photo-1528605248644-14dd04022da1?w=800&q=80&auto=format&fit=crop',
    solutionIds: ['Phytoépuration', 'Toilettes sèches', 'Mare écologique', 'Compostage partagé', 'Canopée & îlots de fraîcheur', 'Atelier de transmission'] },
  { id: 'soc_evenements', nom: 'Événements ouverts organisés', livre: 'social', unite: 'événements/an', point0: 0, point100: 24, poids: 1,
    desc: 'Les ateliers, chantiers participatifs et rencontres ouverts au territoire. Ce qui fait d\'un lieu un espace vivant et partagé.',
    photo: 'https://images.unsplash.com/photo-1511578314322-379afb476865?w=800&q=80&auto=format&fit=crop',
    solutionIds: ['Atelier de transmission', 'Chantier participatif', 'Repair café', 'Café associatif'] },
  // ── Économie locale ──
  { id: 'eco_emplois', nom: 'Emplois locaux créés',     livre: 'economie_locale', unite: 'ETP',        point0: 0,  point100: 5,  poids: 1,
    ...
    photo: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&q=80&auto=format&fit=crop',
    solutionIds: ['AMAP circuit court', 'Réemploi matériaux', 'Approvisionnement local', 'Recyclerie & réemploi local'] },
  { id: 'eco_approv',  nom: 'Approvisionnement local',  livre: 'economie_locale', unite: '% du budget', point0: 20, point100: 80, poids: 1,
    ...
    solutionIds: ['AMAP circuit court', 'Approvisionnement local', 'Café associatif', 'Épicerie participative'] },
  { id: 'eco_biosource', nom: 'Matériaux biosourcés ou réemployés', livre: 'economie_locale', unite: 'tonnes/an', point0: 0, point100: 10, poids: 1,
    ...
    photo: 'https://images.unsplash.com/photo-1500076656116-558758c991c1?w=800&q=80&auto=format&fit=crop',
    solutionIds: ['Isolation paille', 'Réemploi matériaux', 'Toiture végétalisée', 'Ombrières & pergolas bioclimatiques', 'Recyclerie & réemploi local'] },
  { id: 'eco_partenaires', nom: 'Partenaires locaux mobilisés', livre: 'economie_locale', unite: 'partenaires', point0: 0, point100: 20, poids: 1,
    desc: 'Les producteurs, artisans et associations du territoire avec qui le lieu tisse des liens durables. Le maillage de l\'économie de proximité.',
    photo: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&q=80&auto=format&fit=crop',
    solutionIds: ['Approvisionnement local', 'Recyclerie & réemploi local', 'AMAP circuit court', 'Épicerie participative', 'Conserverie anti-gaspi'] },
];
...
const ICI_EXPORTS = {
  ...
  soc_evenements: { odd: [11, 17], esrs: ['S3'],      vsme: ['B8 · Main-d\'œuvre'] },
  eco_emplois:   { odd: [8],      esrs: ['S1', 'S3'], vsme: ['B8 · Main-d\'œuvre'] },
  eco_partenaires: { odd: [8, 17], esrs: ['S2'],      vsme: ['C2 · Chaîne de valeur'] },
